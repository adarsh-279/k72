...
const WorkPage = (props) => {
  return (
    <>
      <div className="w-full h-full relative overflow-hidden hover:rounded-4xl transition-all duration-200 gap-2">
        <img
      ...
      <div className="w-full h-full relative overflow-hidden hover:rounded-4xl transition-all duration-200">
        <img
          className="object-cover h-full w-full"
          src={props.img2}
          alt="Image"
